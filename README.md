# primeiro_projeto_bundle

The 'primeiro_projeto_bundle' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] primeiro_projeto_bundle_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/primeiro_projeto_bundle.job.yml). The schedule
